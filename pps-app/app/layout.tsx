...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_SITE_URL ?? 'https://predictablepipeline.com'
  ),
  title: 'Predictable Pipeline Systems — Client Acquisition Infrastructure for Service Businesses',
  description:
